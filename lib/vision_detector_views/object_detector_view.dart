...
class _ObjectDetectorView extends State<ObjectDetectorView> {
  ...
  Widget build(BuildContext context) {
    //camera view to stream the image from camera
    return CameraView(
      title: 'Object Detector',
      customPaint: _customPaint,
      text: _text,
      onImage: (inputImage) {
        //process to detect the image
  ...
  //there is two mode live and galerry, now only stream mode actived
  ...
  //to initialize detector google ml kit
  ...
  Future<void> processImage(InputImage inputImage) async {
    ...
    //create painter for result of detection
  ...
  Future<String> _getModel(String assetPath) async {
    //get the model tensoflow return file path of model
